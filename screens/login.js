        ...
        <ImageBackground source={require('../assets/background_login.png')} resizeMode={'cover'} style={{ flex: 1 }}>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
                ...
                <View style={styles.formView}>
                    ...
                    {/* inputs */}
                    <InputUser placeHolder='Email' onChangeText={setEmail} valor={email} errorLoginChange={setErrorLogin} />
                    <InputUser placeHolder='Password' onChangeText={setPassword} valor={password} pass={true} errorLoginChange={setErrorLogin}/>
                    ...
                    {email === '' || password === ''
                        ...
                        :
                        <TouchableOpacity style={styles.enablebutton} onPress = {()=> loginFirebase()}>
                    ...
                    <View style = {styles.signupContainer}>
                        ...
                        <TouchableOpacity style={styles.signupbutton} onPress={() => navigation.navigate('Destino')}>
